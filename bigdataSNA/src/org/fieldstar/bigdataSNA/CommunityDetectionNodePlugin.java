 ...
 */
public class CommunityDetectionNodePlugin extends Plugin {
    // The shared instance.
    private static CommunityDetectionNodePlugin plugin;

    /**
     * The constructor.
     */
    public CommunityDetectionNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static CommunityDetectionNodePlugin getDefault() {
        return plugin;
    }
